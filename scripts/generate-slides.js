...
<div style="flex-shrink:0;padding:30px 72px;display:flex;align-items:center;justify-content:space-between;border-top:${dark ? '1px solid rgba(255,255,255,0.12)' : '1.5px solid #e8e5de'}">
  <div style="display:flex;align-items:center;gap:13px">
    ...
    <span style="font-family:'Fraunces',serif;font-size:27px;font-weight:700;color:${dark ? '#fff' : '#1a4731'}">Zen<span style="color:${dark ? '#4ade80' : '#2d6a4f'}">BTW</span></span>
  </div>
...
<div style="width:1080px;height:1920px;display:flex;flex-direction:column;position:relative;overflow:hidden">
  <div style="position:absolute;width:900px;height:900px;border-radius:50%;background:rgba(255,255,255,0.03);top:-350px;right:-300px;pointer-events:none"></div>
  <div style="position:absolute;width:600px;height:600px;border-radius:50%;background:rgba(255,255,255,0.03);bottom:-150px;left:-200px;pointer-events:none"></div>
  <div style="position:absolute;left:0;top:0;bottom:0;width:10px;background:rgba(255,255,255,0.14)"></div>
  <div style="height:10px;background:rgba(255,255,255,0.14);flex-shrink:0"></div>

  <div style="flex:1;display:flex;flex-direction:column;justify-content:center;padding:80px 80px 40px 90px;position:relative;z-index:2">
    ${s.tag ? TAG(s.tag, true) : ''}
    <h1 style="font-family:'Fraunces',serif;font-size:${fs}px;font-weight:900;line-height:1.08;letter-spacing:-0.03em;color:${tx};margin-bottom:30px;white-space:pre-line">${(s.title || '').replace(/<[^>]+>/g, '')}${s.highlight ? `\n<span style="color:${hl}">${s.highlight}</span>` : ''}</h1>
    ${s.sub ? `<p style="font-size:30px;color:${tx2};line-height:1.5;font-weight:500;max-width:860px;margin-bottom:44px">${s.sub}</p>` : ''}
    ${assetSrc ? `<div style="margin-bottom:40px">${MOCKUP(assetSrc, 'zenbtw.nl · BTW check', 300)}</div>` : ''}
    ${s.pill ? `<div style="display:inline-flex;align-items:center;gap:12px;background:rgba(255,255,255,0.1);border:2px solid rgba(255,255,255,0.18);border-radius:100px;padding:16px 34px;font-size:26px;font-weight:700;color:rgba(255,255,255,0.9);width:fit-content">${s.pill}</div>` : ''}
  </div>
  ${FOOTER(true)}
</div>
</body></html>`;
...
<div style="width:1080px;height:1920px;display:flex;flex-direction:column;position:relative;overflow:hidden">
  ...
  <div style="flex:1;display:flex;flex-direction:column;justify-content:center;padding:36px 80px 36px 90px;position:relative;z-index:2">
    ${s.tag ? TAG(s.tag) : ''}
    <h1 style="font-family:'Fraunces',serif;font-size:${fs}px;font-weight:900;line-height:1.08;letter-spacing:-0.03em;color:${tx};margin-bottom:26px;white-space:pre-line">${(s.title || '').replace(/<[^>]+>/g, '')}${s.highlight ? `\n<span style="color:${hl}">${s.highlight}</span>` : ''}</h1>
    ${s.sub ? `<p style="font-size:30px;color:${tx2};line-height:1.5;font-weight:500;max-width:860px;margin-bottom:44px">${s.sub}</p>` : ''}
...
<div style="width:1080px;height:1920px;display:flex;flex-direction:column;position:relative;overflow:hidden">
  ...
  <div style="flex:1;display:flex;flex-direction:column;justify-content:center;padding:72px 90px 40px;position:relative;z-index:2">
    ...
    <div style="font-family:'Fraunces',serif;font-size:${numFs}px;font-weight:900;color:#fff;line-height:0.88;letter-spacing:-0.04em;margin-bottom:28px">${s.number || ''}</div>
...
<div style="width:1080px;height:1920px;display:flex;flex-direction:column">
  ...
  <div style="padding:48px 72px 24px;flex-shrink:0">
    <h1 style="font-family:'Fraunces',serif;font-size:${(s.title || '').length > 42 ? '50' : '58'}px;font-weight:700;color:#1a1814;line-height:1.1;letter-spacing:-0.02em">${s.title || ''}</h1>
  </div>
...
<div style="width:1080px;height:1920px;display:flex;flex-direction:column">
  ...
  <div style="padding:48px 72px 24px;flex-shrink:0">
    <h1 style="font-family:'Fraunces',serif;font-size:${(s.title || '').length > 42 ? '50' : '56'}px;font-weight:700;color:#1a1814;line-height:1.1;letter-spacing:-0.02em;margin-bottom:${s.subtitle ? '14px' : '0'}">${s.title || ''}</h1>
  ...
  <div style="flex:1;padding:0 72px;display:flex;flex-direction:column;gap:16px;justify-content:center">
    ...
    <div style="display:flex;gap:24px;align-items:stretch">
      <div style="display:flex;flex-direction:column;align-items:center;flex-shrink:0">
        <div style="width:60px;height:60px;background:#1a4731;border-radius:14px;display:flex;align-items:center;justify-content:center;font-family:'Fraunces',serif;font-size:24px;font-weight:700;color:#fff;flex-shrink:0">${String(i + 1).padStart(2, '0')}</div>
...
<div style="width:1080px;height:1920px;display:flex;flex-direction:column">
  ...
  ${ASSETS.tools ? `<div style="flex-shrink:0;margin:0;overflow:hidden;height:200px;position:relative">
    ...
    <div style="position:absolute;inset:0;display:flex;align-items:center;padding:0 72px">
      <h1 style="font-family:'Fraunces',serif;font-size:${(s.title || '').length > 38 ? '46' : '54'}px;font-weight:700;color:#fff;line-height:1.1;letter-spacing:-0.02em;text-shadow:0 2px 16px rgba(0,0,0,0.4)">${s.title || ''}</h1>
    </div>
  </div>` : `<div style="padding:52px 72px 24px;flex-shrink:0">
    <h1 style="font-family:'Fraunces',serif;font-size:${(s.title || '').length > 38 ? '48' : '56'}px;font-weight:700;color:#1a1814;line-height:1.1;letter-spacing:-0.02em">${s.title || ''}</h1>
  </div>`}
  ...
  <div style="flex:1;padding:${ASSETS.tools ? '28px' : '0'} 72px;display:flex;flex-direction:column;justify-content:center">
    ...
    <div style="display:grid;grid-template-columns:260px 1fr 1fr;margin-bottom:10px">
      ...
      <div style="background:${colorA};border-radius:14px 14px 0 0;padding:20px 24px;text-align:center">
        <span style="font-family:'Fraunces',serif;font-size:30px;font-weight:700;color:#fff">${colA}</span>
      </div>
      <div style="background:${colorB};border-radius:14px 14px 0 0;padding:20px 24px;text-align:center;margin-left:8px">
        <span style="font-family:'Fraunces',serif;font-size:30px;font-weight:700;color:#fff">${colB}</span>
      </div>
    </div>
    ${rows.map((r, i) => `
...
<div style="width:1080px;height:1920px;display:flex;flex-direction:column">
  ...
  ${ASSETS.tools ? `<div style="flex-shrink:0;height:180px;position:relative;overflow:hidden">
    ...
    <div style="position:absolute;inset:0;padding:0 56px;display:flex;flex-direction:column;justify-content:center">
      <h1 style="font-family:'Fraunces',serif;font-size:50px;font-weight:700;color:#fff;line-height:1.1;letter-spacing:-0.02em;text-shadow:0 2px 12px rgba(0,0,0,0.4)">${s.title || ''}</h1>
    ...
    <h1 style="font-family:'Fraunces',serif;font-size:50px;font-weight:700;color:#1a1814;line-height:1.1;letter-spacing:-0.02em">${s.title || ''}</h1>
  ...
  <div style="display:grid;grid-template-columns:190px repeat(${personas.length},1fr);padding:0 56px;flex-shrink:0;background:#fff;border-bottom:1.5px solid #e8e5de">
    ...
    <div style="display:flex;flex-direction:column;align-items:center;padding:18px 8px">
      <div style="width:76px;height:76px;border-radius:50%;background:${p.color || '#e8f0ec'};border:3px solid #1a4731;display:flex;align-items:center;justify-content:center;font-family:'Fraunces',serif;font-size:24px;font-weight:700;color:#1a4731;margin-bottom:8px">${p.initials || (p.name || '?').slice(0, 2)}</div>
...
<div style="width:1080px;height:1920px;display:flex;flex-direction:column">
  ...
  <div style="padding:48px 72px 20px;flex-shrink:0">
    ${s.tag ? TAG(s.tag) : ''}
    <h1 style="font-family:'Fraunces',serif;font-size:${(s.title || '').length > 40 ? '50' : '58'}px;font-weight:700;color:#1a1814;line-height:1.1;letter-spacing:-0.02em">${s.title || ''}</h1>
  </div>
...
<div style="width:1080px;height:1920px;display:flex;flex-direction:column;position:relative;overflow:hidden">
  ...
  <div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 80px 40px;position:relative;z-index:2;text-align:center">
    ...
    <h1 style="font-family:'Fraunces',serif;font-size:76px;font-weight:900;color:#fff;line-height:1.05;letter-spacing:-0.03em;margin-bottom:28px">${s.question || 'Weet jij waar jij staat?'}</h1>
